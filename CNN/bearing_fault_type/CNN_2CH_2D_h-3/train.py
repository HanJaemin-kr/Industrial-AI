...
def learning_start(set_epoch, set_batch_size):
    # 데이터 로드
    prefix_dir = 'data'
    ...
    dataset_rpm = ['600', '900', '1200', '1500', 'increase']
    files = []
    labels = []
    ...
    base_path = f"./model/model_{set_epoch}_{set_batch_size}"
    extension = ".pt"
    index = 1
